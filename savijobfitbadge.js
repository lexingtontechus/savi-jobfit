MakerBadge.prototype = {
  ...
  init: function (settings, callback) {
    ...
    if (this.layout) {
      if (settings.pic) {
        this.pic = '<img alt="'+(settings.imageAlt ? settings.imageAlt:'SAVI JobFit')+'" width="30" style="border-radius:100%" src="' + settings.pic + '"/>&nbsp;&nbsp;'
      }
    }
  ...
  run: function (callback) {
    ...
    makerbadge.innerHTML = "SAVI JobFit"
    makerbadge.target="_blank"
    makerbadge.href = "https://savivets.org/jobfit"
    ...
    var img = 'https://www.savivets.org/wp-content/uploads/2020/07/savijobfit.png'
    var border = '';
    if(that.theme=='dark'){
      //img = 'https://tinify-bucket.s3-us-west-1.amazonaws.com/blm-blue-round.png'
      img = 'https://www.savivets.org/wp-content/uploads/2020/07/savijobfit.png'
    }
    ...
    const imageAlt = that.imageAlt ? that.imageAlt:'SAVI JobFit'
    ...
    const name = that.title ? that.title : '#jobfit'
...
function MakerBadge(settings) {
  ...
  this.theme=''
  this.title = '#jobfit'
  this.message = 'Hire Our Veterans #jobfit'
  this.pic = ''
  this.promoLink = 'https://savivets.org/jobfit'
  this.promoText = 'SAVI JobFit'+String.fromCodePoint(0x2192)

}

var savijobfitBadge = new MakerBadge()
